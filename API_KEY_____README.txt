...
This file contains the API key to the "themoviedb.org" website service.  In order for this application
...
<resources>
    <string name="THE_MOVIE_DB_API_TOKEN">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</string>
</resources>
----------------------------------
